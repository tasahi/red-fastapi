""" MQTT and Sockets (TCP, UDP, WebSocket) node implementations for FastAPI-Red.
...
from fastapi_red.runtime.eval import get_property, set_property


logger = logging.getLogger("fastapi_red.runtime.socket_nodes")
...
class MQTTBrokerNode(Node):
    ...
    async def start(self) -> None:
        ...
        client_id = self.client_id or f"fastapi_red_{self.id[:8]}"
        try:
