""" Network Node implementations for FastAPI-Red.
...
logger = logging.getLogger("fastapi_red.runtime.network_nodes")
...
class HTTPResponseNode(Node):
    ...
    async def on_input(self, msg: Dict[str, Any]) -> None:
        ...
        """
        from fastapi_red.api.http_in import complete_response
