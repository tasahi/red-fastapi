""" Subflow execution runtime and composite node for FastAPI-Red.
...
from fastapi_red.runtime.eval import evaluate_value


logger = logging.getLogger("fastapi_red.runtime.subflow")
...
class SubflowInstanceNode(Node):
    ...
    def _build_internal_graph(self) -> None:
        ...
        """
        from fastapi_red.runtime.engine import _node_constructors
    ...
    async def handle_error(self, source_node: Node, error_message: str, original_msg: Optional[Dict[str, Any]] = None) -> None:
        ...
        """
        from fastapi_red.runtime.sequence_nodes import CatchNode
    ...
    async def handle_status(self, source_node: Node, status_info: Dict[str, Any]) -> None:
        ...
        """
        from fastapi_red.runtime.sequence_nodes import StatusNode
