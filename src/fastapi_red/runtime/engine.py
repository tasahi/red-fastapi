""" Flow graph execution engine for FastAPI-Red.
...
from fastapi_red.runtime.core_nodes import InjectNode, DebugNode, FunctionNode
...
from fastapi_red.runtime.network_nodes import (
    HTTPInNode,
    HTTPResponseNode,
    HTTPRequestNode,
)
...
from fastapi_red.runtime.parser_nodes import (
    JSONNode,
    CSVNode,
    YAMLNode,
    XMLNode,
...
from fastapi_red.runtime.storage_nodes import (
    FileNode,
    FileInNode,
    S3ConfigNode,
    S3InNode,
...
logger = logging.getLogger("fastapi_red.runtime.engine")
...
class FlowEngine:
    ...
    async def start(self, flow_configs: List[Dict[str, Any]]) -> None:
        ...
        from fastapi_red.runtime.subflow import SubflowInstanceNode
