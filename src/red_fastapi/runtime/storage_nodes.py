""" Storage nodes implementation for Red-Fastapi.
...
from red_fastapi.runtime.eval import evaluate_value, get_property, set_property


logger = logging.getLogger("red_fastapi.nodes.storage")
