""" Advanced Sequence and Flow Control Node implementations for Red-Fastapi.
...
from red_fastapi.runtime.eval import get_property, set_property, delete_property


logger = logging.getLogger("red_fastapi.runtime.sequence_nodes")
